...
export default function SignupPage() {
    const a = UI.auth.signup;

    return (
        <div className="flex min-h-screen items-center justify-center bg-background px-4">
            <Card className="w-full max-w-md border-border/60">
                <CardHeader className="text-center">
                    <Link href="/" className="mb-4 inline-block text-lg font-semibold tracking-tight text-foreground">
                        {UI.siteName}
                    </Link>
                ...
                <CardContent className="space-y-4">
                    ...
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                        <div className="space-y-2">
                            ...
                            <Input id="name" type="text" placeholder={a.namePlaceholder} />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="password" type="password" placeholder={a.passwordPlaceholder} />
                        </div>
                ...
                <CardFooter className="justify-center border-none bg-transparent">
                    <p className="text-sm text-muted-foreground">
                        {a.switchText}{" "}
                        <Link href={a.switchHref} className="font-medium text-primary hover:underline">
                            {a.switchLink}
                        </Link>
                    </p>
                </CardFooter>
